...
function CardModal({ name, phone, email, hireDate, position, department, address, onClose }: CardModalProps) {
	return (
		<>
			...
			<div className='card_modal'>
				...
				<ul className='card_modal_contacts'>
					...
					<li className='card_modal_contacts-item'>
						...
						<span className='card_modal_contacts-text'>{hireDate}</span>
					</li>
					<li className='card_modal_contacts-item'>
						<h2 className='card_modal_contacts-title'>Должность:</h2>
						<span className='card_modal_contacts-text'>{position}</span>
					</li>
					<li className='card_modal_contacts-item'>
